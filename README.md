...
The fit variable indicates that the predicted variable is about 36.45. The range between the lower and upper bound is the area where the model thinks most of the observations would fit into 95% of the time.
